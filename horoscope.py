print("\n===================================================")
print("       WELCOME TO THE WORLD OF ASTRONOMY!     ")
print("===================================================")
print('''    1. Aries        2. Taurus       3. Gemini
...
name = input("\nWhat's your name? ")
print("Hi,", name, end = " ")
s = input("choose a Zodiac number : ")
...
try:
    ...
    while(1):
        if Znumber == 1:
            ...
            print("Hey, you probably has entered a wrong number.")
            Znumber = int(input("Enter a valid Zodiac number : "))
            continue
        ...
        if(again == 'Y'):
            ...
            try:
                ...
                print("Error, can't read the number:(\n")
                break
        else:
